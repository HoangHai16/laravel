					...
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="{{url::to('/trang-chu')}}">
								<img src="{{asset('public/frontend/images/logo.png')}}" alt="" style="width: 139px"/>
							</a>
						</div>
					...
					<div class="col-sm-5">
						<form action="{{URL::to('/tim-kiem')}}" method="POST">
							...
							<div class="search_box pull-right">
								...
								<input type="submit" name="search_item" class="btn btn-primary btn-sm" value="Tìm kiếm" style="margin-top: 0; color: #fff"/>
							</div>
						</form>
					</div>
				</div>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><img src="{{asset('public/frontend/images/logo.png')}}" alt="" style="width: 139px"/></h1>
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="Thương hiệu"><!--brands_products-->
