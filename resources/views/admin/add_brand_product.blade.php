                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="password" style ="resize:none" rows ="5" class="form-control" name="brand_product_desc" id="exampleInputPassword1" placeholder="Mô tả danh muc"></textarea>
                                </div>
                                <div class="form-group">
