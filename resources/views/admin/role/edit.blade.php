            ...
            <section class="panel">
                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <form role="form" action="{{ route('roles.update',['id'=>$role->id]) }}" method="post" style="width : 100%;">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group col-md-12" style="padding: 0">
                                    ...
                                    <textarea type="text" name="display_name" class="form-control" id="exampleInputEmail2" required
                                        placeholder="Nhập tên hiển thị ">{{ $role->display_name }}</textarea>
                                </div>
